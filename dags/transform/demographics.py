...
demo = spark.read.format('csv').load('s3://capstone-mk/raw/demographics/us-cities-demographics.csv', header=True, inferSchema=True, sep=';')\
...
#
demo.write.mode("overwrite").parquet("s3://capstone-mk/lake/us_cities_demographics/")
