...
us_airport = spark.read.parquet("s3://capstone-mk/lake/codes/airport_code/")
city = spark.read.parquet("s3://capstone-mk/lake/city/")
us_wea = spark.read.parquet("s3://capstone-mk/lake/us_cities_temperatures/")
...
airport_weather.write.mode("overwrite").parquet("s3://capstone-mk/lake/us_airports_weather/")
